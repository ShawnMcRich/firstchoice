...
const S: Record<Locale, SC> = {
  fa: {
    ...
    intro: "با تجربه‌ای از سال ۱۳۶۷ و شبکه‌ای از خریداران و مستأجران معتبر — از خانواده‌ها تا سفارت‌خانه‌ها و شرکت‌های خارجی — ملک شما را در هر نقطهٔ ایران، حرفه‌ای به نتیجه می‌رسانیم.",
    ...
    tx: [{ v: "sale", l: "فروش" }, { v: "rent", l: "رهن و اجاره" }, { v: "shortTerm", l: "اجاره ماهانه مبله" }, { v: "fullDeposit", l: "رهن کامل" }, { v: "swap", l: "معاوضه" }, { v: "partnership", l: "مشارکت در ساخت" }],
    ...
    why: ["بیش از ۳۸ سال تجربه و اعتماد (از سال ۱۳۶۷)", "شبکهٔ خریداران و مستأجران معتبر در سراسر ایران", "عکاسی حرفه‌ای و معرفی در سایت، اینستاگرام و دیوار", "تنظیم قرارداد رسمی و دریافت کد رهگیری", "پشتیبانی و پاسخ‌گویی به سه زبان فارسی، انگلیسی و عربی"],
  ...
  en: {
    ...
    intro: "Backed by experience since 1988 and a network of vetted buyers and tenants — from families to embassies and international companies — we bring your property to a result, anywhere in Iran, professionally.",
    ...
    tx: [{ v: "sale", l: "Sale" }, { v: "rent", l: "Rent (deposit & monthly)" }, { v: "shortTerm", l: "Monthly furnished" }, { v: "fullDeposit", l: "Full deposit (Rahn)" }, { v: "swap", l: "Swap" }, { v: "partnership", l: "Build partnership" }],
    ...
    why: ["38+ years of trusted experience (since 1988)", "A network of vetted buyers and tenants across Iran", "Professional photography + exposure on site, Instagram & Divar", "Official registered contracts", "Multilingual support — Persian, English & Arabic"],
  ...
  ar: {
    ...
    intro: "بخبرة منذ ١٩٨٨ وشبكة من المشترين والمستأجرين الموثوقين — من العائلات إلى السفارات والشركات الأجنبية — نُوصل عقارك إلى نتيجة في أي مكان بإيران، باحتراف.",
    ...
    tx: [{ v: "sale", l: "بيع" }, { v: "rent", l: "إيجار" }, { v: "shortTerm", l: "إيجار شهري مفروش" }, { v: "fullDeposit", l: "رهن كامل" }, { v: "swap", l: "مقايضة" }, { v: "partnership", l: "مشاركة" }],
    ...
    why: ["أكثر من ٣٨ عامًا من الخبرة الموثوقة (منذ ١٩٨٨)", "شبكة من المشترين والمستأجرين الموثوقين في كل إيران", "تصوير احترافي وعرض على الموقع وإنستغرام وديوار", "عقود رسمية مُسجّلة", "دعم بثلاث لغات: الفارسية والإنجليزية والعربية"],
