...
const R: Record<Locale, RC> = {
  fa: {
    ...
    tx: [{ v: "sale", l: "خرید" }, { v: "rent", l: "رهن و اجاره" }, { v: "shortTerm", l: "اجارهٔ کوتاه‌مدت" }, { v: "fullDeposit", l: "رهن کامل" }],
  ...
  en: {
    ...
    tx: [{ v: "rent", l: "Rent" }, { v: "shortTerm", l: "Short-term" }, { v: "fullDeposit", l: "Full deposit" }],
  ...
  ar: {
    ...
    tx: [{ v: "rent", l: "إيجار" }, { v: "shortTerm", l: "إيجار قصير" }, { v: "fullDeposit", l: "رهن كامل" }],
