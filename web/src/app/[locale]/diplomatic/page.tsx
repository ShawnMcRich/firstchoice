...
const D: Record<Locale, DC> = {
  en: {
    ...
    trust: [{ b: "38+ years", s: "serving missions" }, { b: "All Tehran", s: "every district" }, { b: "EN / FA / AR", s: "multilingual team" }, { b: "To your budget", s: "matched to your budget" }],
    ...
    services: [
      ...
      { h: "Monthly furnished leases", p: "Monthly leases matched to your posting, renewals handled ahead of time." },
      { h: "Registered contract & translation", p: "Contract executed with a tracking code (کد رهگیری) and a certified translated copy." },
      { h: "Curated, vetted homes", p: "A hand-picked selection matched to your brief and standard." },
      { h: "All Tehran districts", p: "Across all districts of Tehran — not only the north — near missions, international schools and healthcare." },
  ...
  fa: {
    ...
    trust: [{ b: "۳۸+ سال", s: "در خدمت سفارت‌خانه‌ها" }, { b: "تمام تهران", s: "همهٔ مناطق" }, { b: "FA / EN / AR", s: "تیم چندزبانه" }, { b: "مطابق بودجه", s: "متناسب با بودجهٔ شما" }],
    ...
    services: [
      ...
      { h: "اجارهٔ ماهانه مبله", p: "اجارهٔ ماهانه متناسب با دورهٔ مأموریت، با تمدید به‌موقع." },
      { h: "قرارداد رسمی و ترجمه", p: "انجام قرارداد با کد رهگیری و نسخهٔ ترجمه." },
      { h: "املاک منتخب و بررسی‌شده", p: "مجموعه‌ای گلچین‌شده، متناسب با نیاز و استاندارد شما." },
      { h: "تمام مناطق تهران", p: "در تمام مناطق تهران (نه فقط شمال) — نزدیک به سفارت‌خانه‌ها، مدارس بین‌المللی و مراکز درمانی." },
  ...
  ar: {
    ...
    trust: [{ b: "+٣٨ عامًا", s: "في خدمة السفارات" }, { b: "كل طهران", s: "جميع المناطق" }, { b: "FA / EN / AR", s: "فريق متعدد اللغات" }, { b: "حسب ميزانيتك", s: "بما يناسب ميزانيتك" }],
    ...
    services: [
      ...
      { h: "إيجار شهري مفروش", p: "إيجار شهري يناسب فترة التعيين مع تجديد مسبق." },
      { h: "عقد رسمي وترجمة", p: "تنفيذ العقد برمز تتبّع (کد رهگیری) ونسخة مترجمة معتمدة." },
      { h: "عقارات منتقاة ومدقّقة", p: "مجموعة مختارة بعناية تناسب متطلباتكم ومستواكم." },
      { h: "جميع مناطق طهران", p: "في جميع مناطق طهران (وليس الشمال فقط) — قرب السفارات والمدارس الدولية والرعاية." },
